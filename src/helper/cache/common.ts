...
import { ThemeColorEnum } from '@/constants/base'
...
const themeColorCache = 'themeColorCache'

export function getThemeColorCache() {
  return cacheUtils.get(themeColorCache) as ThemeColorEnum
}

export function setThemeColorCache(val: ThemeColorEnum) {
  return cacheUtils.set(themeColorCache, val)
}
...
export const isWebClip = 'IS_WEB_CLIP'

export function getIsWebClipCache() {
  return cacheUtils.get(isWebClip)
}

export function setIsWebClipCache(data) {
  return cacheUtils.set(isWebClip, data)
}

export const IsVestBag = 'IS_VEST_BAG'

export function getIsVestBagCache() {
  return cacheUtils.get(IsVestBag)
}

export function setIsVestBagCache(data) {
  return cacheUtils.set(IsVestBag, data)
}
