...
import {
  wsMarketCommonSub,
  wsMarketSectorConceptList,
  wsMarketTernaryOptionCommonSub,
  wsTradePairSubFullAmount,
  wsTradePairSubSlow,
} from './common'
...
/** Ternary option */
const wsTernaryOptionMarketCommonSub = partial(wsMarketTernaryOptionCommonSub, {
  biz: WsBizEnum.option,
  type: WsTypesEnum.market,
})

const wsTernaryOptionTradePairSubFullAmount = partial(wsTradePairSubFullAmount, {
  biz: WsBizEnum.option,
  type: WsTypesEnum.ternaryOptionFullAmount,
})
...
export {
  ...
  wsTernaryOptionTradePairSubFullAmount,
}
