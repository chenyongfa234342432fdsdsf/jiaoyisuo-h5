...
import {
  YapiGetV1PerpetualMerClearingCoinApiResponse,
  YapiGetV1PerpetualMerClearingCoinApiRequest,
} from '@/typings/yapi/PerpetualMerClearingCoinV1GetApi'
import {
  YapiGetV1PerpetualGroupQueryAllApiRequest,
  YapiGetV1PerpetualGroupQueryAllApiResponse,
} from '@/typings/yapi/PerpetualGroupQueryAllV1GetApi'
...
/**
 * 现货止盈止损下单
 * https://yapi.admin-devops.com/project/44/interface/api/18649
 */
export const createSpotStopLimitOrder: MarkcoinRequest<ICreateSpotStopLimitOrderReq> = data => {
  return request({
 ...
 * 获取用户展示币对类型
 */
export const getSymbolTypeSettings: MarkcoinRequest = () => {
  return request({
 ...
 * 设置用户展示币对类型
 */
export const setSymbolTypeSettings: MarkcoinRequest = data => {
  return request({
