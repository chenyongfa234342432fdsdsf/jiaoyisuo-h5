...
import { Form, Field, Button, Flex, Uploader, Toast, Image, UploaderValueItem } from '@nbit/vant'
...
export default function UserSafetyItemsApplicationForm() {
  ...
  return (
    <section className={`application-form ${styles.scoped}`}>
      <NavBar title="" right={<Icon name="close" hasTheme />} onClickRight={() => link('/home-page')} />
      ...
      {submitSuccess && (
        <div className="submit-success">
          <div className="icon">
            <LazyImage src={`${oss_svg_image_domain_address}register_success.png`} hasTheme />
          </div>
