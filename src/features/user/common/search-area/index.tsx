...
import { Search, Cell, Image, Popup, IndexBar, IndexBarInstance } from '@nbit/vant'
    ...
    >
      <div className="search-area-wrap">
        ...
        <Search
          ...
          clearTrigger="always"
          clearIcon={<Icon name="del_input-box" hasTheme onClick={handleClear} />}
        />
                  ...
                  <div key={indexItem}>
                    ...
                    {filterList.map((v: MemberMemberAreaType, index) => (
                      <Cell
                        ...
                        icon={<LazyImage src={`${oss_area_code_image_domain_address}${v.remark}.png`} />}
                      />
                    ))}
                  </div>
                )
            ...
            <>
              {loading ? (
                ...
                <div className="no-result">
                  <LazyImage src={`${oss_svg_image_domain_address}no_data_icon`} imageType={Type.svg} hasTheme />
