  ...
  return (
    <div className="p-4 flex justify-between items-center">
      ...
      <div className="flex flex-1 justify-end">
        <DomAutoScaleWrapper className="justify-end" dep={orderDetail.statusCd}>
          <div className="flex justify-end">{buttonNode}</div>
        </DomAutoScaleWrapper>
      </div>
    </div>
  )
  ...
  return (
    <div>
      {(buyTipVisible || sellTipVisible) && (
        <div className="flex px-4 py-2 bg-brand_color_special_02">
