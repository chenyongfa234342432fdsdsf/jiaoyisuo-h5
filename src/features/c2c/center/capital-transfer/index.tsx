...
import { Input, Toast, Button } from '@nbit/vant'
...
function CapitalTransfer() {
  ...
  const onPreData = async () => {
    ...
    if (isOk && data) {
      ...
      Toast.success(
        c2cMode.isPublic
          ? t`features_c2c_center_capital_transfer_index_ctyybmjsqp`
          : t`features_c2c_center_capital_transfer_index_s9yfftnsefjl9kltj4ocj`
      )
    }
    setFalse()
  }
