...
const animationData = 'market_spot_intro_light'
const animationDataDark = 'market_spot_intro_dark'
...
export default function MarketListSpotIntro({ apiStatus, data }) {
  ...
  const lottieData = common.theme === ThemeEnum.dark ? animationDataDark : animationData
