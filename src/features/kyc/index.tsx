...
import { Tabs, Popup, PopupPosition, Button, Image } from '@nbit/vant'
...
export default function KycIndex() {
  ...
  useMount(() => {
    const tab = pageContext.urlParsed.search.tab
    if (tab) {
      updateAssetsModule({
        activeTab: tab,
      })
    ...
    switch (data.kycType) {
      ...
      case kycType.notCertiFied:
        return (
          <div>
            <LazyImage
              src={`${oss_svg_image_domain_address}equity_not_certified.png`}
        ...
        return (
          <div>
            <div className="text-left mt-6">
              <div>
                <Icon name="icon_equity_buy" className="mr-2" />
            ...
            <div className="text-left mt-6">
              <div>
                <Icon name="icon_equity_sell" className="mr-2" />
                <span className="text-text_color_01 text-base font-semibold">
            ...
            <div className="text-left mt-6">
              <div>
                <Icon name="icon_equity_recharge" className="mr-2" />
                <span className="text-text_color_01 text-base font-semibold">
            ...
            <div className="text-left mt-6">
              <div>
                <Icon name="icon_equity_withdrawal" className="mr-2" />
                <span className="text-text_color_01 text-base font-semibold">
  ...
  const tabs = useCreation(() => {
    return [
      { title: t`features_kyc_index_5101110`, content: <KycIndexStand />, id: KycTabEnum.stand },
      { title: t`features_kyc_index_5101111`, content: <KycIndexAdvanced />, id: KycTabEnum.advanced },
      { title: t`features_kyc_index_5101112`, content: <KycIndexBusiness />, id: KycTabEnum.enterprise },
    ]
  }, [])
      ...
      <div className="kyc-index-wrap">
        <div className="kyc-index-wrap-top">
          <div className="top">
            ...
            <span className="icon">
              <Icon name="icon_personal_certification" className="text-2xl" />
            </span>
          </div>
          <div className="bottom">
            <span className="tag relative" onClick={() => setState('bottom')}>
              <LazyImage
                width={20}
                height={20}
                className="w-5 h-5 absolute inline-block left-2 top-1.5"
                src={`${oss_svg_image_domain_address}icon_certification_equity.png`}
              />
