...
import { Button, Image } from '@nbit/vant'
      ...
      <div className="title relative">
        ...
        <div className={isOver ? 'over -top-1.5' : 'hidden'}>
          <LazyImage
            ...
            width={15}
            height={15}
            src={`${oss_svg_image_domain_address}user_verifieduser_verified.png`}
          />
        ...
        return (
          <div key={menu.title} className="menu-item rv-hairline--bottom">
            <div className="flex item-center">
              <Icon className="icon_n" name={menu.icon} />
