...
const baseTernaryOptionFavStore = create(devtools(getFavStore, { name: 'market-ternary-option-fav-store' }))
const useTernaryOptionFavStore = createTrackedSelector(baseTernaryOptionFavStore)
...
export {
  ...
  baseFuturesFavStore,
  useFuturesFavStore,
  baseTernaryOptionFavStore,
  useTernaryOptionFavStore,
}
