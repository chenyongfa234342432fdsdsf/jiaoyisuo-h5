...
import ternaryOptionTradeModule from '@/store/market/market-list/ternary-option-trade-module'
...
function getBaseStore(set, get) {
  ...
  return {
    ...
    [MarketLisModulesEnum.ternaryOptionMarketsTrade]: ternaryOptionTradeModule(set, get),
