...
const Table = <T,>({ apiStatus, ...props }: Itable<T>) => {
  const { data, columns, sortable = true, hasPopover = false, defaultSorter, setData, allNoClickSort } = props
