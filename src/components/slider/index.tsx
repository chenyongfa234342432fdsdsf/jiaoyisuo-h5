...
import { Slider as VantSlider, SliderProps } from '@nbit/vant'
...
function Slider({
  ...
  return (
    ...
    >
      {((!props.disabled && props.showTooltip) || alwaysShowTooltip) && (
        <div
          className={classnames('tooltip', {
            show: showTooltip || alwaysShowTooltip,
          })}
          style={{
            left: `calc(${value}%)`,
        ...
        >
          <span className="scale-75">{customTooltipNode || `${value}%`}</span>
          <div
        ...
        <div className="slider-points">
          {points.map(point => {
            ...
            return (
              <div
                key={pointValue}
                className={classnames('slider-point-wrap', {
