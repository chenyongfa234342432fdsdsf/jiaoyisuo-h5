...
import { useFuturesFavStore, useSpotFavStore, useTernaryOptionFavStore } from '@/store/market/market-favorite'
import { useFuturesFavActions, useSpotFavActions, useTernaryOptionFavActions } from '@/hooks/features/market/favourite'
...
function CollectStarSwitch(props) {
  ...
  switch (currentModule) {
    ...
    case MarketLisModulesEnum.ternaryOptionMarketsTrade:
      return <BaseCollectStar data={rest} dataStore={useTernaryOptionFavStore} actions={useTernaryOptionFavActions} />
    default:
