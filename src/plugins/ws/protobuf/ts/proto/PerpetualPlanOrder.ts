...
// @generated from protobuf file "proto/PerpetualPlanOrder.proto" (syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message PerpetualPlanOrder
 */
export interface PerpetualPlanOrder {
    /**
...
class PerpetualPlanOrder$Type extends MessageType<PerpetualPlanOrder> {
    constructor() {
        super("PerpetualPlanOrder", [
    ...
    create(value?: PartialMessage<PerpetualPlanOrder>): PerpetualPlanOrder {
        const message = { uid: "0", groupId: "0", orderId: "0", businessId: 0, orderState: "", tradeId: 0, symbol: "", reason: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<PerpetualPlanOrder>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: PerpetualPlanOrder): PerpetualPlanOrder {
    ...
    internalBinaryWrite(message: PerpetualPlanOrder, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* sint64 uid = 1; */
        if (message.uid !== "0")
...
/**
 * @generated MessageType for protobuf message PerpetualPlanOrder
 */
export const PerpetualPlanOrder = new PerpetualPlanOrder$Type();
