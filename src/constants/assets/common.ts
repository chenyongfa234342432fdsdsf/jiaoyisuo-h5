...
import { AssetsCoinRemindSettingTypeEnum } from '.'
...
export const getAssetsDepositType = (type: AssetsCoinRemindSettingTypeEnum) => {
  return {
    [AssetsCoinRemindSettingTypeEnum.recharge]: AssetsSelectCoinTypeEnum.recharge,
    [AssetsCoinRemindSettingTypeEnum.withdraw]: AssetsSelectCoinTypeEnum.withdraw,
  }[type]
}
...
export enum AssetsRecordTypeEnum {
  ...
  /** 娱乐区退回 */
  recreationReturn = 605,
}

/** 财务记录 - 娱乐区类型 */
export const RecordRecreationTypeList: AssetsRecordTypeEnum[] = [
  AssetsRecordTypeEnum.recreationBuy,
  AssetsRecordTypeEnum.recreationProfit,
  AssetsRecordTypeEnum.recreationReturn,
]

/**
 * c 财务记录 - 三元期权类型
 */
export const RecordOptionTypeList: AssetsRecordTypeEnum[] = [
  AssetsRecordTypeEnum.optionBuy,
  AssetsRecordTypeEnum.optionProfit,
]
...
export const RecordCommissionTypeList: AssetsRecordTypeEnum[] = [
  ...
  AssetsRecordTypeEnum.optionFee,
  AssetsRecordTypeEnum.entertainmentFee,
  AssetsRecordTypeEnum.threeLevelFee,
  AssetsRecordTypeEnum.pyramidFee,
  AssetsRecordTypeEnum.areaFee,
]
 ...
 * 财务记录 - 时间类型 - 空数据展示名称
 */
export const getAssetsRecordDateTypeEmptyName = (type: AssetsRecordDateTypeEnum) => {
  return {
    [AssetsRecordDateTypeEnum.day]: t`constants_assets_common_y2mns6kw2n`,
    [AssetsRecordDateTypeEnum.week]: t`constants_assets_common_rvxrm5wkev`,
    [AssetsRecordDateTypeEnum.month]: t`constants_assets_common_htuvdildua`,
    [AssetsRecordDateTypeEnum.threeMonths]: t`constants_assets_common_jfzfjznfx2`,
  }[type]
}
...
export enum AssetsDictionaryTypeEnum {
  ...
  /** 财务日志列表 - 返佣类型 */
  recordRebateType = 'rebate_type_cd',
  /** 财务日志列表 - 类型-c2c */
