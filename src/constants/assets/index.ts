...
export const setFinancialRecordRoute = type => {
  return {
    ...
    [AssetsRouteEnum.derivative]: FinancialRecordRouteEnum.derivative,
  }[type]
}
...
/** 返佣类型 */
export enum FinancialRecordRebateTypeEnum {
  /** 团队返佣 */
...
/**
 * 提币 - 剩余 24 小时内可提现 USD 额度
 */
export enum WithdrawUsdLimitEnum {
  /** 无限制 */
  unlimited = '-1',
}
...
export const OSSDOMAIN_IMAGE = oss_svg_image_domain_address
