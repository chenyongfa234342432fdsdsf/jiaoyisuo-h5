...
export function getOrderingUnitEnumName(type: OrderingUnitEnum) {
  return {
    [OrderingUnitEnum.buy]: t`constants_future_settings_c0zapr8uqu`,
    [OrderingUnitEnum.sell]: t`constants_future_settings_yiwuen9hxz`,
  }[type]
}
