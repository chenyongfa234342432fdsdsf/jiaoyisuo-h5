...
export type MemberDemoIsOpenResp = {
  isOpen: boolean // 是否成功
}

export type MemberRegisterDemoResp = {
  token: string // token
  refreshToken: string // refreshToken
  refreshTokenExpireTime: number // refreshTokenExpireTime
  tokenExpireTime: number // tokenExpireTime
  usrMemberSettingsVO: MemberBaseSettingsInfoResp // 会员设置
  userInfo: UserInfoType // 会员信息
}