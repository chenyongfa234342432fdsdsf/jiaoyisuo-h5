...
const getWsMarketTradeBySub = (subscription, ws, key: 'symbolWassName' | 'symbol' = 'symbolWassName') => {
  return ({ apiData }) => {
    ...
    useUpdateEffect(() => {
      ...
      setResolvedData((mergeTradePairWithWsDataByWassName(resolvedData as any, wsData || [], key) || []) as any)
    }, [wsData])
...
export const useWsTernaryOptionMarketTradePairFullAmount = getWsMarketTradeBySub(
  wsTernaryOptionTradePairSubFullAmount,
  optionWs,
  'symbol'
)
