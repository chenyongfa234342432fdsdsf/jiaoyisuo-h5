import { spotFavFn, contractFavFn, ternaryOptionFavFn } from '@/helper/market/market-favorite'
import useReqeustMarketHelper from '@/hooks/features/market/common/use-request-market'
import { useSpotFavStore, useFuturesFavStore, useTernaryOptionFavStore } from '@/store/market/market-favorite'
...
const useTernaryOptionFavList = () => useFavList(ternaryOptionFavFn, useTernaryOptionFavStore)
const useTernaryOptionFavActions = () => useFavActions(ternaryOptionFavFn, useTernaryOptionFavStore)
