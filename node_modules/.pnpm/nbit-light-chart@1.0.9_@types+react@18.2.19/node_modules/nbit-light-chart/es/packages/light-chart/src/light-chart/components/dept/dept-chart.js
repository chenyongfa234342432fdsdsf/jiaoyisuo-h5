...
var DeptChart = function DeptChart(props) {
  ...
  useEffect(function () {
    ...
    var isUp = props.data[props.data.length - 1].value - (((_props$data = props.data[props.data.length - 2]) === null || _props$data === void 0 ? void 0 : _props$data.value) || 0) > 0;
