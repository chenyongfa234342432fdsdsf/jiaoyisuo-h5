...
import {
  decimal_default
} from "./chunk-DMSVSM2Z.js";
import {
  require_lodash
} from "./chunk-JX4T3XOT.js";
import {
  __export,
  __toESM
} from "./chunk-KYYS6LIU.js";

// node_modules/.pnpm/@nbit+utils@1.0.1-beta.48/node_modules/@nbit/utils/es/decimal/index.js
var decimal_exports = {};
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.48/node_modules/@nbit/utils/es/market/index.js
var market_exports = {};
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.48/node_modules/@nbit/utils/es/fast-url/index.js
...
__export(fast_url_exports, {
  ...
  getFastManyBusinessUrl: () => getFastManyBusinessUrl,
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.48/node_modules/@nbit/utils/es/security/index.js
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.48/node_modules/@nbit/utils/es/env/index.js
var env_exports = {};
__export(env_exports, {
  ...
  getEnvS3MaintenanceApiUrl: () => getEnvS3MaintenanceApiUrl,
...
var getBaseEnvS3Url = function getBaseEnvS3Url2(mode, type) {
  ...
  if (mode === EnvTypesEnum.test) {
    if (extType === ExtTypesEnum.im) {
      return getFastUrl2("https://im-staging-s3-saas.s3.ap-southeast-1.amazonaws.com/".concat(type));
    }
...
var getEnvS3MaintenanceApiUrl = function getEnvS3MaintenanceApiUrl2(mode, businessId) {
  switch (mode) {
    case EnvTypesEnum.production:
      return getFastUrl2("https://newbit-prod-s3-saas.s3.ap-northeast-1.amazonaws.com/".concat(businessId, "_maintenanceConfig.json"));
    case EnvTypesEnum.dev:
      return getFastUrl2("https://newbit-dev-s3-saas.s3.ap-southeast-1.amazonaws.com/".concat(businessId, "_maintenanceConfig.json"));
    case EnvTypesEnum.test:
      return getFastUrl2("https://newbit-staging-s3-saas.s3.ap-southeast-1.amazonaws.com/".concat(businessId, "_maintenanceConfig.json"));
    default:
      return getFastUrl2("https://newbit-dev-s3-saas.s3.ap-southeast-1.amazonaws.com/".concat(businessId, "_maintenanceConfig.json"));
  }
};

// node_modules/.pnpm/@nbit+utils@1.0.1-beta.48/node_modules/@nbit/utils/es/vite-plugins/index.js
var vite_plugins_exports = {};
__export(vite_plugins_exports, {
  cssModuleHMR: () => cssModuleHMR
});

// node_modules/.pnpm/@nbit+utils@1.0.1-beta.48/node_modules/@nbit/utils/es/vite-plugins/css-hmr.js
...
// node_modules/.pnpm/@nbit+utils@1.0.1-beta.48/node_modules/@nbit/utils/es/index.js
setPrecision(40);
export {
